...
setwd('/GWSPH/home/vtinney/results3/pm/')
library(raster)
library(rgdal)
library(dplyr)
library(ggplot2)
...
for (i in 1:length(beta.groups)){
  ...
  for (j in 1:length(conc.groups)){
    ...
    if(i == 7 | i == 8 | i == 9 | i == 13 | i == 14 | i == 15 | i == 22 | 
      ...
      clip.groups <- c('Export_Output','oak', 'alaco2')
    ...
    hia[hia==0]<-NA
      ...
      f1 = paste('/GWSPH/home/vtinney/results3/pm/af/',names(clip.groups[m]),', ',outcome.groups[i],', ',names(conc.groups[j]),', ',names(beta.groups[i]),'.tif',sep='')
      ...
      f2 = paste('/GWSPH/home/vtinney/results3/pm/mr/',names(clip.groups[m]),', ',outcome.groups[i],', ',names(conc.groups[j]),', ',names(beta.groups[i]),', ',rate.names,'.tif',sep='')
      ...
      f3 = paste('/GWSPH/home/vtinney/results3/pm/paf/',names(clip.groups[m]),', ',outcome.groups[i],', ',names(conc.groups[j]),', ',names(beta.groups[i]),', ',rate.names,', ',pop.names,'.tif',sep='')
