...
setwd("/GWSPH/home/vtinney/results3/pm/df/final/")

#list.files()
#[1] "pm.cbg.results.csv"    "pm.city.results.csv"   "pm.county.results.csv"
#[4] "pm.results.csv"


#/////////////////////////////////////////////////////////////////////////////////////////////////
# Part 1 - text to columns of all aggregated results
df <- read.csv('pm.results.csv')
...
write.csv(x2,'pm.results.tables.csv')


#/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
# Replicate for CBG tables

cbg <- read.csv("pm.cbg.results.csv")
...
write.csv(x4,'pm.cbg.results.tables.csv')

#/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
# Replicate for County tables

co <- read.csv('pm.county.results.csv')
...
write.csv(x4,'pm.co.results.tables.csv')
...
df <- read.csv("pm.city.results.csv")
...
x4$estimate.t <- paste0(x4$point.t,' (',x4$lower.t,'-',x4$upper.t,')',sep='') 
write.csv(x4,'pm.city.results.tables.csv')
