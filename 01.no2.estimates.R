...
setwd('/GWSPH/home/vtinney/results3/no2/')
library(raster)
library(rgdal)
library(dplyr)
library(ggplot2)
...
#clip.groups <- c('Export_Output','oak','alaco2','bay')
...
for (i in 1:length(beta.groups)){
  ...
  for (j in 1:length(conc.groups)){
    ...
    if((i == 1 | i == 2 | i == 3 | i == 4 | i == 5 | i == 6 |
        ...
        i == 28 | i == 29 | i == 30 | i == 34 | i == 35 | i == 36) & (j == 1 | j == 3)){
    ...
    for (m in 1:length(clip.groups)){    
      ...
      f1 = paste('/GWSPH/home/vtinney/results3/no2/af/',names(clip.groups[m]),', ',outcome.groups[i],', ',names(conc.groups[j]),', ',names(beta.groups[i]),'.tif',sep='')
      ...
      f2 = paste('/GWSPH/home/vtinney/results3/no2/mr/',names(clip.groups[m]),', ',outcome.groups[i],', ',names(conc.groups[j]),', ',names(beta.groups[i]),', ',rate.names,'.tif',sep='')
      ...
      f3 = paste('/GWSPH/home/vtinney/results3/no2/paf/',names(clip.groups[m]),', ',outcome.groups[i],', ',names(conc.groups[j]),', ',names(beta.groups[i]),', ',rate.names,', ',pop.names,'.tif',sep='')
