...
#===================================================================================================
dir <- c('/GWSPH/home/vtinney/results3/bc/af/',
         '/GWSPH/home/vtinney/results3/bc/paf/',
         '/GWSPH/home/vtinney/results3/bc/mr/')
...
for (i in 1:length(dir)){
  ...
  for (k in 1:length(files)){
    ...
    fout = paste0('/GWSPH/home/vtinney/results3/bc/df/',files[k],names(dir[i]),'.csv',sep='')
    write.csv(paf, fout)
    rm(p)
  }}

setwd('/GWSPH/home/vtinney/results3/bc/df/')
filenames <- list.files(path='/GWSPH/home/vtinney/results3/bc/df/',pattern="*.csv", full.names=TRUE)
...
dir <- c('/GWSPH/home/vtinney/results3/bc/')
...
for (i in 1:length(dir)){
  ...
  for (k in 1:length(files)){
    ...
    fout = paste0('/GWSPH/home/vtinney/results3/bc/df/cbg/',files[k],'.csv',sep='')
    write.csv(p, fout)
    rm(p)
  }}

setwd('/GWSPH/home/vtinney/results3/bc/df/cbg/')
