...
#===================================================================================================
dir <- c('/GWSPH/home/vtinney/results3/pm/af/',
         '/GWSPH/home/vtinney/results3/pm/paf/',
         '/GWSPH/home/vtinney/results3/pm/mr/')
...
for (i in 1:length(dir)){
  ...
  for (k in 1:length(files)){
    ...
    fout = paste0('/GWSPH/home/vtinney/results3/pm/df/',files[k],names(dir[i]),'.csv',sep='')
    write.csv(paf, fout)
    rm(p)
  }}

setwd('/GWSPH/home/vtinney/results3/pm/df/')
filenames <- list.files(path='/GWSPH/home/vtinney/results3/pm/df/',pattern="*.csv", full.names=TRUE)
...
dir <- c('/GWSPH/home/vtinney/results3/pm/')
...
for (i in 1:length(dir)){
  ...
  for (k in 1:length(files)){
    ...
    fout = paste0('/GWSPH/home/vtinney/results3/pm/df/cbg/',files[k],'.csv',sep='')
    write.csv(p, fout)
    rm(p)
  }}

setwd('/GWSPH/home/vtinney/results3/pm/df/cbg/')
filenames <- list.files(path='/GWSPH/home/vtinney/results3/pm/df/cbg/',pattern="*.csv", full.names=TRUE)
dataset <- do.call("rbind",lapply(filenames,FUN=function(files){read.csv(files, header=TRUE, sep=",")}))
...
for (i in 1:length(dir)){
  ...
  for (k in 1:length(files)){
    ...
    p$filenames <- paste0(files[k],names(dir[i]))
    fout = paste0('/GWSPH/home/vtinney/results3/pm/df/city/',files[k],'.csv',sep='')
    write.csv(p, fout)
    rm(p)
  }}


setwd('/GWSPH/home/vtinney/results3/pm/df/city/')
filenames <- list.files(path='/GWSPH/home/vtinney/results3/pm/df/city/',pattern="*.csv", full.names=TRUE)
dataset <- do.call("rbind",lapply(filenames,FUN=function(files){read.csv(files, header=TRUE, sep=",")}))
...
for (i in 1:length(dir)){
  ...
  for (k in 1:length(files)){
    ...
    p$filenames <- p$NAMELSAD.x
    p$filenames <- paste0(files[k],names(dir[i]))
    fout = paste0('/GWSPH/home/vtinney/results3/pm/df/county/',files[k],names(dir[i]),'.csv',sep='')
    write.csv(p, fout)
    rm(p)
  }}


setwd('/GWSPH/home/vtinney/results3/pm/df/county/')
filenames <- list.files(path='/GWSPH/home/vtinney/results3/pm/df/county/',pattern="*.csv", full.names=TRUE)
dataset <- do.call("rbind",lapply(filenames,FUN=function(files){read.csv(files, header=TRUE, sep=",")}))
